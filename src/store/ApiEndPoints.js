...
export const ApiEndpoints = {
  auth: {
    ...
    generateOTP: '/api/generate-otp/',
    verifyOTP: '/api/verify-otp/', //verify otp and login otp based 
  ...
  cart: {
    ...
    getCartItems: '/api/cards/list/USER_ID/',
    deleteCart: 'api/card-items/delete-zero-item/CART_ID/',
    deleteWholeCart: 'api/cards/USER_ID/',

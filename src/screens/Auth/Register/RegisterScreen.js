    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={{ flex: 1, backgroundColor: 'red' }}>
                <ImageBackground
                    ...
                    <View style={styles.overlay}>
                        ...
                        <Text style={styles.subTitlee}>Signing-Up and Exploring Gungun</Text>
                    </View>
                </ImageBackground>
            </View>
            <View style={styles.loginView}>
                <ScrollView>
                    <Formik
                        initialValues={{ resturantName: '', fullName: '', password: '', phoneNumber: '', email: '' }}
                        ...
                        {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                            <View style={{ marginHorizontal: 20 }}>
                                ...
                                <View style={styles.inputContainer}>
                                    <Octicons name="person" size={20} color="#DEA812" style={styles.imageIcon} />
                                    <TextInput
                                        style={styles.input}
                                ...
                                <View style={styles.inputContainer}>
                                    <Feather name="lock" size={20} color="#DEA812" style={styles.imageIcon} />
                                    <TextInput
                                        style={styles.input}
                                    ...
                                    />
                                    {secureTextEntry ? <Feather name="eye-off" size={20} color="#ccc" onPress={toggleSecureEntry} /> : <Feather name="eye" size={20} color="#ccc" onPress={toggleSecureEntry} />}
                                </View>
                                ...
                                <View style={styles.inputContainer}>
                                    <Entypo name="email" size={20} color="#DEA812" style={styles.imageIcon} />
                                    <TextInput
                                        style={styles.input}
